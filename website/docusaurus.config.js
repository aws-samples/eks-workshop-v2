  ...
  themeConfig:
    ...
    ({
      announcementBar: {
        id: "upgrade-1.30",
        content:
          '🚩 EKS Workshop upgraded to EKS 1.30 on 26th July. If you have an existing lab environment please see the <a target="_blank" rel="noopener noreferrer" href="/docs/misc/major-upgrade">major upgrade instructions</a>. 🚩',
