...
1. (Line: Network Load Balancer로 생성합니다
2. (Line: 13-14) NLB는 80번 포트에서 수신하고 8080 포트의 `ui` Pod로 연결을 전달합니다
3. (Line: 16-20) 여기서는 pod의 레이블을 사용하여 이 서비스의 대상으로 추가될 pod를 지정합니다
