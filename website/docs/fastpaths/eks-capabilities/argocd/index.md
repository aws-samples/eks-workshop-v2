...
- An IAM Identity Center group + admin user were created by Terraform (see [Sign in to Argo CD via Identity Center](./signin-argocd.md) for the user activation step). The group is mapped to the Argo CD **ADMIN** role on the capability.
