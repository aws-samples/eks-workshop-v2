...
![Workshop Studio Home](../../introduction/setup/assets/workshop-studio-home.webp)

You will be prompted to sign in. Select the option **Email One-Time Password(OTP)**.

<img src={require('../../introduction/setup/assets/ws-studio-login.webp').default} alt="Workshop Studio Sign in" style={{width: '400px'}} />
...
![Event Code](../../introduction/setup/assets/event-code.webp)

Read and accept the Terms and Conditions and click **Join event** to continue.

![Review and Join](../../introduction/setup/assets/review-and-join.webp)
...
![Open Console](../../introduction/setup/assets/openconsole.webp)
...
![Cloud9 Link](../../introduction/setup/assets/workshop-studio-06.png)

You will be prompted for a password:

![IDE Password](../../introduction/setup/assets/visual-studio-01.png)

Enter the value from the **IdePassword** field from the outputs and the web IDE will load.

![Code-server login screen](../../introduction/setup/assets/vscode-splash.webp)

Press **Get started** to access the workshop splash page:

![Get Started](../../introduction/setup/assets/workshop-event-page.webp)
