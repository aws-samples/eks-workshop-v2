...
:::tip
*If you do not see the eks-workshop Cloud9 environment this is because it is owned by another IAM user. [Click here](/misc/index.md) to see how to resolve the issue.*
:::
