...
By participating in this workshop you will be provided with an AWS account to use to complete the lab material. Connect to the portal by browsing to [https://catalog.workshop/terraforms.aws/](https://catalog.workshop/terraforms.aws/), where the following screen shows up.
